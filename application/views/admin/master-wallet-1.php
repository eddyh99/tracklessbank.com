            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link active" href="master-wallet-1.html">
                ...
                <div class="container-fluid px-4">
                    <div class="col-12 box-dashboard-freedy-top px-3 py-5 mt-3 mb-4 d-flex flex-row align-items-center">
                        <div class="d-flex flex-column me-auto">
                            <h3 class="fw-bold text-blue-freedy mb-4">MASTER WALLET M3RC4N73</h3>
                    ...
                    <div class="col-12 my-5">
                        <a href="master-wallet-2.html" class="btn btn-freedy-blue fw-bold px-5 py-3">Withdraw</a>
                    </div>
