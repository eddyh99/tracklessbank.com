        ...
        <div class="container-fluid px-4">
            <div class="col-12 card mt-3">
                ...
                <div class="card-body">
                    ...
                    <?php } ?>
                    <form action="<?= base_url() ?>m3rc4n73/mwallet/wdconfirm" method="post" id="form_submit" onsubmit="return validate()">
                        <input type="hidden" id="token" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                        <input type="hidden" name="transfer_type" value="outside">
                        <?php if ($_SESSION["currency"] == "USD") { ?>
                            <div class="mb-3">
                                <input class="form-control" type="text" name="recipient" id="inter1" placeholder="Recipient">
                            </div>
                            <div class="mb-3">
                                <input class="form-control" type="text" name="account_number" id="inter2" placeholder="Account Number">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <input class="form-control" type="text" name="address" id="inter6" placeholder="Recipient Address">
                            </div>
                            <div class="mb-3">
                                <input class="form-control" type="text" name="city" id="inter7" placeholder="Recipient City">
                            </div>
                            <div class="mb-3">
                                <input class="form-control" type="text" name="state" id="inter8" placeholder="Recipient State">
                            </div>
                            <div class="mb-3">
                                <input class="form-control" type="text" name="postalcode" id="inter9" placeholder="Recipient Postalcode">
                            </div>
                            <div class="mb-3">
                        ...
                        <?php } elseif ($_SESSION["currency"] == "EUR") { ?>
                            <div class="mb-3">
                                <input class="form-control" type="text" name="recipient" id="us1" placeholder="Recipient's Name">
                            </div>
                            <div class="mb-3">
