        ...
        <div class="row gx-5 align-items-center">
            <div class="col-lg-7">
                ...
                <div class="mb-5 mb-lg-0 text-start">
                    <h1 class="f-dmsans text-white mb-3">
                        Open your own<br>
                        Online Bank
                        <svg class="line" width="231" height="10" viewBox="0 0 231 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M1.99998 7.28623C44.4229 3.94673 149.19 -0.964693 228.874 6.1057" stroke="#1AA37A" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    </h1>
                    <p class="text-trackless lead fw-normal mt-3 mb-3">
                            ...
                            <div class="">
                                <p class="mb-2">
                                    <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path d="M11.5001 15.3791L18.3941 8.48438L19.4553 9.54488L11.5001 17.5001L6.72705 12.7271L7.78755 11.6666L11.5001 15.3791Z" fill="black" />
                                    </svg>
                                    License
                                </p>
                            </div>
                        ...
                        <div class="box-service">
                            <div class="text-center">
                                <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M16.8333 14.5V33.1667H35.5V35.5H14.5V14.5H16.8333ZM34.6752 18.3418L36.3248 19.9915L29.6667 26.6497L26.1667 23.1508L21.1582 28.1582L19.5085 26.5085L26.1667 19.8503L29.6667 23.3492L34.6752 18.3418V18.3418Z" fill="black" />
                                </svg>
                    ...
                    <div class="col-12 col-sm-6 col-lg-6 p-2">
                        <div class="box-service">
                            <div class="text-center">
                                <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect width="50" height="50" rx="25" fill="#00DD9C" />
                                    <path d="M24.3594 18.125H21.6875V16.3438H19.9062V28.8125H17.2344V30.5938H19.9062V32.375H21.6875V19.9062H24.3594V18.125Z" fill="black" />
                                    <path d="M35.0469 19.9062H32.375V16.3438H30.5938V27.0312H27.9219V28.8125H30.5938V32.375H32.375V21.6875H35.0469V19.9062Z" fill="black" />
                                    <path d="M37.7188 37.7188H14.5625C14.0901 37.7188 13.637 37.5311 13.303 37.197C12.9689 36.863 12.7812 36.4099 12.7812 35.9375V12.7812H14.5625V35.9375H37.7188V37.7188Z" fill="black" />
                                </svg>
                    ...
                    <div class="col-12 col-sm-6 col-lg-6 p-2">
                        <div class="box-service">
                            <div class="text-center">
                                <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect width="50" height="50" rx="25" fill="#00DD9C" />
                                    <path d="M26.1665 21.5H35.4998L23.8332 39V28.5H15.6665L26.1665 11V21.5ZM23.8332 23.8333V19.4233L19.7872 26.1667H26.1665V31.293L31.14 23.8333H23.8332Z" fill="black" />
                                </svg>
    ...
    <div class="container px-5 refferal-slide">
        <div class="row gx-5 justify-content-center">
            <div class="col-12 col-lg-8 col-xl-8" style="position: relative;">
                <svg class="circle-1" width="155" height="155" viewBox="0 0 155 155" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="77.5" cy="77.5" r="77.5" fill="#00DD9C" />
                </svg>
                <svg class="circle-2" width="116" height="116" viewBox="0 0 116 116" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-12 col-lg-8 domain-text text-white">
                    <h2 class="f-baij my-3">
                        ...
                        <svg width="25" height="38" viewBox="0 0 25 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M14.4063 7.38067C15.4498 8.84159 16.0108 10.5921 16.0108 12.3874V14.1195C16.5607 14.1195 17.0949 13.9357 17.5284 13.5973C17.9618 13.2588 18.2698 12.7852 18.4032 12.2517L18.578 11.5523L19.0522 12.1215C19.8169 13.0391 20.2319 14.1979 20.2237 15.3923C20.2154 16.5867 19.7843 17.7396 19.007 18.6465C18.7157 18.9863 18.
                            <path d="M1.25361 7.70195C1.0834 7.70195 0.920155 7.63434 0.799795 7.51398C0.679434 7.39362 0.611816 7.23037 0.611816 7.06016V5.77656C0.611816 5.60635 0.679434 5.4431 0.799795 5.32274C0.920155 5.20238 1.0834 5.13477 1.25361 5.13477C1.42383 5.13477 1.58707 5.20238 1.70743 5.32274C1.82779 5.4431 1.89541 5.60635 1.89541 5.77656V7.06016C1.89541 7.23037 1.82779 7.39362 1.70743 7.51398C1.58707 7.63434 1.42383 7.70195 1.25361 7.70195Z" fill="#FFB895" />
                            <path d="M23.7165 15.4031C23.5463 15.4031 23.383 15.3355 23.2627 15.2151C23.1423 15.0948 23.0747 14.9315 23.0747 14.7613V13.4777C23.0747 13.3075 23.1423 13.1443 23.2627 13.0239C23.383 12.9036 23.5463 12.8359 23.7165 12.8359C23.8867 12.8359 24.05 12.9036 24.1703 13.0239C24.2907 13.1443 24.3583 13.3075 24.3583 13.4777V14.7613C24.3583 14.9315 24.2907 15.0948 24.1703 15.2151C24.05 15.3355 23.8867 15.4031 23.7165 15.4031Z" fill="#FE691E" />
                            <path d="M21.7912 10.9109C21.621 10.9109 21.4578 10.8433 21.3374 10.723C21.217 10.6026 21.1494 10.4394 21.1494 10.2691V8.98555C21.1494 8.81533 21.217 8.65209 21.3374 8.53173C21.4578 8.41137 21.621 8.34375 21.7912 8.34375C21.9614 8.34375 22.1247 8.41137 22.245 8.53173C22.3654 8.65209 22.433 8.81533 22.433 8.98555V10.2691C22.433 10.4394 22.3654 10.6026 22.245 10.723C22.1247 10.8433 21.9614 10.9109 21.7912 10.9109Z" fill="#FF8D54" />
                            <path d="M24.3581 8.98535C24.1879 8.98535 24.0246 8.91773 23.9043 8.79737C23.7839 8.67701 23.7163 8.51377 23.7163 8.34356V6.41816C23.7163 6.24795 23.7839 6.08471 23.9043 5.96435C24.0246 5.84399 24.1879 5.77637 24.3581 5.77637C24.5283 5.77637 24.6916 5.84399 24.8119 5.96435C24.9323 6.08471 24.9999 6.24795 24.9999 6.41816V8.34356C24.9999 8.51377 24.9323 8.67701 24.8119 8.79737C24.6916 8.91773 24.5283 8.98535 24.3581 8.98535Z" fill="#FFB895" />
                            <defs>
                                <linearGradient id="paint0_linear_1588_29279" x1="12.4136" y1="0" x2="12.4136" y2="37.2242" gradientUnits="userSpaceOnUse">
                ...
                <div class="col-12">
                    <div class="row d-flex justify-content-center">
                        <div class="col-12 col-sm-6 col-md-4 col-lg-4 p-3">
                            <a href="https://freedybank.com/" class="cs-powered text-center" style="color: #fff;text-decoration: none;">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-4 p-3">
                            <a href="https://piggybankservice.com/" class="cs-powered text-center" style="color: #fff;text-decoration: none;">
                                <div class="box-powered text-center">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-4 p-3">
                            <a href="https://exchangetailor.com/" class="cs-powered text-center" style="color: #fff;text-decoration: none;">
                                <div class="box-powered text-center">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-4 p-3">
                            <a href="https://moneyport.org/" class="cs-powered text-center" style="color: #fff;text-decoration: none;">
                                <div class="box-powered text-center">
