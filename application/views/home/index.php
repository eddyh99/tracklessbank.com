            ...
            <div class="col-12 col-lg-12 my-5">
                ...
                <div class="col-12">
                    ...
                    foreach ($banks as $data) {
                        if ($data->member=='trackless'){
                         if ($data->is_comingsoon == 'no') {
                    ?>
                        <div class="col-12 col-sm-6 col-md-4 col-lg-4 p-3">
                            <a href="<?=$data->site?>" class="cs-powered text-center" style="color: #fff;text-decoration: none;">
                                <div class="box-powered text-center">
                                    <img src="<?= $data->logodark ?>" alt="<?= $data->bank_name ?>">
                                </div>
                            </a>
                        </div>
                    <?php }else{ ?>
                        <div class="col-12 col-sm-6 col-md-4 col-lg-4 p-3 text-center">
                            <a class="cs-powered text-center" style="color: #fff;text-decoration: none;">
                                <div class="mb-2 box-powered text-center">
                                    <img src="<?= $data->logodark ?>" alt="<?= $data->bank_name ?>">
                                </div>
                            </a>
                            <span style="color: #fff;text-decoration: none;">Coming Soon</span>
                        </div>
                    <?php }
                        }
                    } ?>
