...
class Cost extends CI_Controller
{
	...
	public function editdcost()
	{
		...
		if (@$url->code == 200) {
			$mdata = array(
				...
				"topup_circuit_pct" => number_format($url->message->topup_circuit_pct, 2, ".", ","),
				"topup_outside_fxd" => number_format($url->message->topup_outside_fxd, 2, ".", ","),
				"topup_outside_pct" => number_format($url->message->topup_outside_pct, 2, ".", ","),
				"wallet_sender_fxd" => number_format($url->message->wallet_sender_fxd, 2, ".", ","),
				"wallet_sender_pct" => number_format($url->message->wallet_sender_pct, 2, ".", ","),
				"wallet_receiver_fxd" => number_format($url->message->wallet_receiver_fxd, 2, ".", ","),
				"wallet_receiver_pct" => number_format($url->message->wallet_receiver_pct, 2, ".", ","),
				"walletbank_circuit_fxd" => number_format($url->message->walletbank_circuit_fxd, 2, ".", ","),
				"walletbank_circuit_pct" => number_format($url->message->walletbank_circuit_pct, 2, ".", ","),
				"walletbank_outside_fxd" => number_format($url->message->walletbank_outside_fxd, 2, ".", ","),
				"walletbank_outside_pct" => number_format($url->message->walletbank_outside_pct, 2, ".", ","),
	...
	public function editdcost_prosses()
	{
		...
		$dataUpdate = array(
			...
			"topup_circuit_pct" => $topup_circuit_pct,
			"topup_outside_fxd" => $topup_outside_fxd,
			"topup_outside_pct" => $topup_outside_pct,
			"wallet_sender_fxd" => $wallet_sender_fxd,
			"wallet_sender_pct" => $wallet_sender_pct,
			"wallet_receiver_fxd" => $wallet_receiver_fxd,
			"wallet_receiver_pct" => $wallet_receiver_pct,
			"walletbank_circuit_fxd" => $walletbank_circuit_fxd,
			"walletbank_circuit_pct" => $walletbank_circuit_pct,
			"walletbank_outside_fxd" => $walletbank_outside_fxd,
			"walletbank_outside_pct" => $walletbank_outside_pct,
			"swap" => $swap,
			"currency" => $curr,
		);
	...
	public function editbcost()
	{
		...
		if (@$url->code == 200) {
			$mdata = array(
				...
				"transfer_circuit_pct" => number_format($url->message->transfer_circuit_pct, 2, ".", ","),
				"transfer_outside_fxd" => number_format($url->message->transfer_outside_fxd, 2, ".", ","),
				"transfer_outside_pct" => number_format($url->message->transfer_outside_pct, 2, ".", ","),
				"topup_circuit_fxd" => number_format($url->message->topup_circuit_fxd, 2, ".", ","),
				"topup_circuit_pct" => number_format($url->message->topup_circuit_pct, 2, ".", ","),
				"topup_outside_fxd" => number_format($url->message->topup_outside_fxd, 2, ".", ","),
				"topup_outside_pct" => number_format($url->message->topup_outside_pct, 2, ".", ",")
	...
	public function editbcost_prosses()
	{
		...
		$dataUpdate = array(
			...
			"transfer_circuit_pct" => $transfer_circuit_pct,
			"transfer_outside_fxd" => $transfer_outside_fxd,
			"transfer_outside_pct" => $transfer_outside_pct,
			"topup_circuit_fxd" => $topup_circuit_fxd,
			"topup_circuit_pct" => $topup_circuit_pct,
			"topup_outside_fxd" => $topup_outside_fxd,
			"topup_outside_pct" => $topup_outside_pct,
	...
	public function getbcost()
	{
		...
		if (@$mfee->code == 200) {
			$mdata = array(
				...
				"transfer_circuit_pct" => number_format($mfee->message->transfer_circuit_pct, 2, ".", ","),
				"transfer_outside_fxd" => number_format($mfee->message->transfer_outside_fxd, 2, ".", ","),
				"transfer_outside_pct" => number_format($mfee->message->transfer_outside_pct, 2, ".", ","),
				"topup_circuit_fxd" => number_format($mfee->message->topup_circuit_fxd, 2, ".", ","),
				"topup_circuit_pct" => number_format($mfee->message->topup_circuit_pct, 2, ".", ","),
				"topup_outside_fxd" => number_format($mfee->message->topup_outside_fxd, 2, ".", ","),
				"topup_outside_pct" => number_format($mfee->message->topup_outside_pct, 2, ".", ",")
			);
		} else {
			$mdata = array(
				"transfer_circuit_fxd" => number_format(0, 2, ".", ","),
	...
	public function getdcost()
	{
		...
		if (@$mfee->code == 200) {
			$mdata = array(
				...
				"wallet_sender_pct" => number_format($mfee->message->wallet_sender_pct, 2, ".", ","),
				"wallet_receiver_fxd" => number_format($mfee->message->wallet_receiver_fxd, 2, ".", ","),
				"wallet_receiver_pct" => number_format($mfee->message->wallet_receiver_pct, 2, ".", ","),
				"walletbank_circuit_fxd" => number_format($mfee->message->walletbank_circuit_fxd, 2, ".", ","),
				"walletbank_circuit_pct" => number_format($mfee->message->walletbank_circuit_pct, 2, ".", ","),
				"walletbank_outside_fxd" => number_format($mfee->message->walletbank_outside_fxd, 2, ".", ","),
				"walletbank_outside_pct" => number_format($mfee->message->walletbank_outside_pct, 2, ".", ","),
